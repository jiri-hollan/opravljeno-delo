<?php
     ...
     $a0= ''; 
	 $a1= '';
	/* 	 '<li><a href="../delo/prijavljeniUporabnikObjekt.php?nazaj='.$nazaj.'&akce=novZapis">Vpis</a> </li>		   
	       <li><a href="../delo/manipulaceObjektPrijavljeni.php?tabulka=deloTbl">ogled</a></li>';
