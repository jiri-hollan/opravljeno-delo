...
switch(akce) {
  ...
  case "vloz":
    ...
    sifraOpravila= '<input type="int" id="sifraId" name="sifraOpravila" value="" placeholder="sifraOpravila" required>';
    document.getElementById("demo").innerHTML = sifraOpravila + opravilo ;
...
row_value = y.cells[0].innerHTML;
 ...
 window.location.href = "manipulaceOpravila.php?akce=" + x.innerHTML + "&id=" + row_value;  
}//od function(e)